...
export const POST = async (req: Request): Promise<Response> => {
	...
	const stream = createUIMessageStream<MyMessage>({
		execute: async ({ writer }) => {
			...
			const step = TODO; // TODO: keep track of the step we're on
			const mostRecentDraft = TODO; // TODO: keep track of the most recent draft
			const mostRecentFeedback = TODO; // TODO: keep track of the most recent feedback
